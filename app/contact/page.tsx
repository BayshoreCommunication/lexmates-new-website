          ...
          <div className="contact-details">
            ...
            {parvez && (
              <div className="contact-card">
                ...
                {parvez.contact.usaPhone && (
                  <p>
                    <strong>USA:</strong>{' '}
                    <a href={`https://wa.me/${parvez.contact.usaPhone.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer">
                      {parvez.contact.usaPhone}
                    </a>
                  </p>
                )}
                <p>
                  <strong>Email:</strong>{' '}
                  <a href={`mailto:${parvez.contact.email}`}>{parvez.contact.email}</a>
                </p>
              </div>
            )}
            ...
            {arif && (
              <div className="contact-card">
                ...
                <p>
                  <strong>Email:</strong>{' '}
                  <a href={`mailto:${arif.contact.email}`}>{arif.contact.email}</a>
                </p>
              </div>
            )}
            ...
            <div className="contact-card address-card">
              ...
              <p>
                ...
                Road No-04, Block-F
                <br />
                Kolwalapara, Dhaka 1216, Bangladesh
              </p>
            </div>
          </div>
        </div>
